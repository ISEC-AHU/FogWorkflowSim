...
public class UI1 extends JFrame {
	...
	private final JLabel lblNewLabel_1 = new JLabel("MaxMin");
...
//		FitTableColumns(table);
		...
		lblNewLabel_1.setBounds(28, 87, 95, 15);
		AlgorithmsPanel.add(lblNewLabel_1);
		...
		lblPso_1.addMouseListener(new MouseListener(){
			@Override
			public void mouseClicked(MouseEvent e) {
				if(psoSettingPanel.isVisible())
					psoSettingPanel.setVisible(false);
				else psoSettingPanel.setVisible(true);
			}
			public void mousePressed(MouseEvent e) {}
			public void mouseReleased(MouseEvent e) {}
			public void mouseEntered(MouseEvent e) {
				lblPso_1.setForeground(Color.RED);
			}
			public void mouseExited(MouseEvent e) {
				lblPso_1.setForeground(null);
			}
		});
		...
		lblGa_1.addMouseListener(new MouseListener(){
			@Override
			public void mouseClicked(MouseEvent e) {
				if(gaSettingPanel.isVisible())
					gaSettingPanel.setVisible(false);
				else gaSettingPanel.setVisible(true);
			}
			public void mousePressed(MouseEvent e) {}
			public void mouseReleased(MouseEvent e) {}
			public void mouseEntered(MouseEvent e) {
				lblGa_1.setForeground(Color.RED);
			}
			public void mouseExited(MouseEvent e) {
				lblGa_1.setForeground(null);
			}
		});
		...
		btnAddAlgorithm.setBounds(20, 347, 126, 52);
